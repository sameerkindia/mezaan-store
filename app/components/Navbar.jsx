...
const styles = {
  ...
  dropdownLink: { display: 'block', padding: '8px', color: 'var(--primary-dark)', fontWeight: 'bold', textDecoration: 'none', marginBottom: '5px', textAlign: 'center', background: '#f3f4f6', borderRadius: '3px' },
};
